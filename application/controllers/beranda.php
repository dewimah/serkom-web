...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Chakra+Petch&family=Montserrat+Alternates:ital,wght@1,300&family=Turret+Road&display=swap" rel="stylesheet">
    <title>Beranda</title>
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color:#F0F8FF;">
  <a class="navbar-brand" href="#">Jalan Setapak</a>
...
<center>
<div class="maharani">
<div class="single" style="width:730px;">
  <center><h2>Enjoy It</h2></center><hr>
  <video width="600px" height="500" controls>
